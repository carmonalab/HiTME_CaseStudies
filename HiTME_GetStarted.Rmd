...
File can be downloaded from (https://figshare.com/ndownloader/files/43848153). This includes 3 samples in a list.
...
We can also visualize the cell type annotation in a UMAP representation. Let's do it for `layer`, showing the broad cell type classification.
